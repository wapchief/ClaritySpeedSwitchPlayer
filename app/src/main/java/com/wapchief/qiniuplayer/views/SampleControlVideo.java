...
import com.wapchief.qiniuplayer.VideoModel;
...
public class SampleControlVideo extends StandardGSYVideoPlayer {
    ...
    public boolean setUp(List<VideoModel> urls, boolean cache, String title) {
        mUrlList = urls;
        return setUp(urls.get(mSourcePosition).getUrl(), cache, title);
    }
